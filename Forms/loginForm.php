    ...
    <div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md border border-gray-200">
      ...
      <form action="">
        <div class="mb-5">
          ...
          <input type="text" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#FF4B4B]/50 focus:border-[#FF4B4B]" placeholder="Enter your full name">
        </div>

        <div class="mb-5">
          <label for="emailaddress" class="block text-gray-700 font-medium mb-2">Email Address</label>
          <input type="email" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#FF4B4B]/50 focus:border-[#FF4B4B]" placeholder="Enter your email address">
        </div>
